...
from t5_flash_attn import add_flash_attn
...
def main():  # pylint: disable=too-many-branches,too-many-locals,too-many-statements
    ...
    with smp.model_creation(
        ...
        # Replace T5Attention with T5FlashAttention to support flash attention in T5
        if args.model_type == "flan_t5" and args.flash_attention > 0:
            add_flash_attn(model, model_config)
