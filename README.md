...
- [Ground Truth Object Detection Tutorial](ground_truth_labeling_jobs/object_detection_tutorial) is similar end-to-end example but for an object detection task.
