...
# this script is modified from https://github.com/NVIDIA/DeepLearningExamples/blob/master/TensorFlow/LanguageModeling/BERT/scripts/run_squad.sh
# with 2 more input arg options: RESULTS_DIR and do_train
...
export SQUAD_DIR=$BERT_PREP_WORKING_DIR/download/squad/v${squad_version}
...
init_checkpoint=${10:-"$pretrained_modeldir/model.ckpt"}
epochs=${11:-"2.0"}

BERT_DIR=$pretrained_modeldir
...
RESULTS_DIR=${12:-"/results/${TAG}_${DATESTAMP}"}
do_train=${13:-"true"}
do_predict=${14:-"false"}
