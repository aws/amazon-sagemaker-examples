...
def _get_file_names():
    ...
    file_names = {
        'train':      ['data_batch_%d' % i for i in range(1, 5)],
        'validation': ['data_batch_5'], 'eval': ['test_batch']
    }
    return file_names
...
def download_cifar10_tf_records(data_dir):
    """

    Args:
        data_dir (string):  Directory to download and extract CIFAR-10 to.
    """
