...
agent_params.network_wrappers['main'].input_embedders_parameters = {
        'front_camera': InputEmbedderParameters(activation_function='relu'),
...
SilverstoneInputFilter.add_observation_filter('lidar', 'clipping', ObservationClippingFilter(0.15, 1.0))
