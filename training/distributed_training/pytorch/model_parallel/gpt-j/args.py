...
class SMPArguments:
    ...
    microbatches: Optional[int] = field(
        default = 1, metadata={"help": "Microbatches"}
    )
    ...
    optimize: Optional[str] = field(
        default = "speed", metadata={"help": "What to optimize for -- must be 'speed' or 'memory'"}
    )
        
    activation_strategy: Optional[str] = field(
        default = "each", metadata={"help": ""}
    )
            
    shard_optimizer_state: Optional[int] = field(
        default = 0, metadata={"help": ""}
    )
        
    offload_activations: Optional[int] = field(
        default = 0, metadata={"help": ""}
    )
    ...
    static_mode: Optional[int] = field(
        default = 0, metadata={"help": ""}
    )
            
    delayed_param: Optional[int] = field(
        default = 0, metadata={"help": ""}
    )
    same_partition_load: Optional[int] = field(
        default = 0, metadata={"help": ""}
    )                 
    attention_in_fp32: Optional[int] = field(
        default = 1, metadata={"help": ""}
    )   
    ddp: Optional[bool] = field(
        default = False, metadata={"help": ""}
    )
    activation_checkpointing: Optional[int] = field(
        default = 0, metadata={"help": ""}
    )
    ...
    match_weights: Optional[int] = field(
        default=0,
        metadata={
            "help": "Get weights from the original model"
        },
    )
    fp32_grad_accumulation: Optional[int] = field(
        default=0,
        metadata={
            "help": "Enable FP32 Grad accumulation"
        },
    )   
