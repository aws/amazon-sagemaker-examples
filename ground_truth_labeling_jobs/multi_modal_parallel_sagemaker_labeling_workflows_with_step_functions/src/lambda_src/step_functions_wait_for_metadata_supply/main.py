...
def lambda_handler(event, context):
    ...
    """
    batch_id, step_token, output_location = event["batch_id"], event["token"], event["output_location"]
    ...
    log.logger.info("Publishing SNS notification to : " + first_level_job_completion_sns_arn + str(message))
