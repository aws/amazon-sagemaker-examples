...
SHALLOW_LIDAR_INPUT_EMBEDDER = {
    ...
    Input.LIDAR.value: {
        ...
        SchemeInfo.BN_INFO_CONV.value: [False, ActivationFunctions.RELU.value, 0.0],
        SchemeInfo.BN_INFO_DENSE.value: [True, ActivationFunctions.RELU.value, 0.5],
        SchemeInfo.IS_FIRST_LAYER_BN.value: False,
    },
}
...
SHALLOW_LIDAR_SETEREO_LEFT_INPUT_EMBEDDER = {
    Input.LEFT_CAMERA.value: {
        SchemeInfo.CONV_INFO_LIST.value: [[32, 8, 4], [64, 4, 2], [64, 3, 1]],
        SchemeInfo.DENSE_LAYER_INFO_LIST.value: [],
        SchemeInfo.BN_INFO_CONV.value: [False, ActivationFunctions.RELU.value, 0.3],
        SchemeInfo.BN_INFO_DENSE.value: [False, ActivationFunctions.RELU.value, 0.0],
        SchemeInfo.IS_FIRST_LAYER_BN.value: False,
    },
    Input.STEREO.value: {
...
DEEP_INPUT_EMBEDDER = {
    Input.CAMERA.value: {
        ...
        SchemeInfo.BN_INFO_CONV.value: [True, ActivationFunctions.TANH.value, 0.0],
...
VGG_LEFT_STEREO_INPUT_EMBEDDER = {
    Input.CAMERA.value: {
        SchemeInfo.CONV_INFO_LIST.value: [[32, 8, 4], [32, 4, 2], [64, 4, 2], [64, 3, 1]],
        SchemeInfo.DENSE_LAYER_INFO_LIST.value: [512, 512],
        SchemeInfo.BN_INFO_CONV.value: [True, ActivationFunctions.RELU.value, 0.0],
