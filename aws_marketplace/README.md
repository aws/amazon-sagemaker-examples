...
- [Using Model Packages](using_model_packages)
  ...
  - [Person counting use case model evaluation deep dive](aws_marketplace/using_model_packages/person_counting_use_case_model_evaluation_deep_dive) will show you how to use two AWS Marketplace GluonCV pre-trained ML models for person counting use case and evaluate each model for performance in different types of crowd images.	
