...
def main():
    ...
    if training_args.do_train:
        ...
        ### SageMaker Support ###
        # HuggingFace Trainer automatically saves both model and checkpoints to the same output-dir.
        # Copy the final HuggingFace trainer model to the SageMaker model folder.
        src_dir = training_args.output_dir
        dest_dir = '/opt/ml/model'
        # Final model is saved at the root of the specified output-dir.
        model_files = (
