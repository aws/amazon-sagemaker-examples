...
def run(args, parser):
    ...
    with RolloutSaver(
        ...
        rollout(agent, args.env, num_steps, num_episodes, saver, args.no_render, video_dir)
...
def rollout(agent, env_name, num_steps, num_episodes=0, saver=None, no_render=True, video_dir=None):
