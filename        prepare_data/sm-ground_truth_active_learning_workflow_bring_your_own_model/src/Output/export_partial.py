...
def merge_manifests(full_input, partial_output):
    ...
    logger.info("Loaded input manifest of size {} to memory.".format(len(complete_manifest)))
...
def lambda_handler(event, context):
    ...
    logger.info("Downloaded input and output manifests {}, {}".format(s3_input_uri, s3_output_uri))
