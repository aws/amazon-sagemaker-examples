...
def test_peform_active_learning(monkeypatch):
    ...
    class MockSimpleActiveLearning:
        ...
        def autoannotate(self, predictions, sources):
            return [
                '{"source": "This is a message about cat", "category": 1, "category-metadata": {"confidence": 1.0, "human-annotated": "no", "type": "groundtruth/text-classification"}}'
            ]
    ...
    event = {
        ...
        "meta_data": {
            ...
            "transform_config": {"S3OutputPath": "s3://input/"},
