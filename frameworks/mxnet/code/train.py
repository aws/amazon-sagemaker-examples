...
class MNIST(Dataset):
    def __init__(self, data_dir, train=True, transform=None):
        ...
        self.images, self.labels = self._convert_to_numpy(data_dir, images_file, labels_file)
...
def get_data_loader(data_dir, batch_size, train=True):
    ...
    return gluon.data.DataLoader(mnist, batch_size=batch_size, shuffle=True, last_batch="rollover")
