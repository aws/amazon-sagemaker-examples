...
for i in range(0, num_shards):
    ...
    name=f"/home/ubuntu/openwebtext_seq_512_no_pad_filtered/val/test_dataset_512_filtered_{i}"
    print(name)
    print(shard_test)
...
​
for i in range(0, num_shards):
    name=f"/home/ubuntu/openwebtext_seq_512_no_pad_filtered/train/train_dataset_512_filtered_{i}"
    print(name)
