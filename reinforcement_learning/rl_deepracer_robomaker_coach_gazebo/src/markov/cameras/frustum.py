...
from markov.cameras.utils import normalize
...
class Frustum(object):
    ...
    def _update_temp(self):
        with self.lock:
            ...
            for camera_offset in self.camera_offsets:
                ...
                planes = self._calculate_frustum_planes(cam_pos=cam_pos,
    ...
    def test_visibility(self, point):
        ...
        """
        with self.lock:
            if not isinstance(point, list) and isinstance(point, tuple) \
