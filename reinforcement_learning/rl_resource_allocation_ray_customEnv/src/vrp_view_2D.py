...
class VRPView2D:
    ...
    def __draw_orders(self, o_status, o_res_map, o_x, o_y):
        ...
        for o in range(self.n_orders):
            if o_status[o] != 0:
                ...
                rgb = self.restaurant_rgb_map[o_res_map[o]]
                if o_status[o] == 1:
    ...
    def __draw_legend(self):
        ...
        pygame.draw.rect(self.game_surface, self.restaurant_rgb_map[0], (ox - 4, oy - 4, 8, 8))
        ...
        pygame.draw.circle(self.game_surface, self.restaurant_rgb_map[0], (ox, oy), 6, 6)
