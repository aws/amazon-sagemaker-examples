class ExperimentRecord:
    ...
    def __init__(
        ...
        self._next_model_to_train_id = training_workflow_metadata.get(
        ...
        self._last_evaluation_job_id = evaluation_workflow_metadata.get(
            "last_evaluation_job_id", None
        )
        self._next_evaluation_job_id = evaluation_workflow_metadata.get(
