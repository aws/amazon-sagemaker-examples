...
agent_params.network_wrappers['main'].learning_rate = hyperp.learning_rate
...
agent_params.network_wrappers['main'].batch_size = hyperp.batch_size
agent_params.network_wrappers['main'].optimizer_epsilon = hyperp.optimizer_epsilon
agent_params.network_wrappers['main'].adam_optimizer_beta2 = hyperp.adam_optimizer_beta2

agent_params.algorithm.clip_likelihood_ratio_using_epsilon = hyperp.clip_likelihood_ratio_using_epsilon
agent_params.algorithm.clipping_decay_schedule = LinearSchedule(1.0, 0, 1000000)
agent_params.algorithm.beta_entropy = hyperp.beta_entropy # also try 0.001
agent_params.algorithm.gae_lambda = hyperp.gae_lambda
agent_params.algorithm.discount = hyperp.discount
agent_params.algorithm.optimization_epochs = hyperp.optimization_epochs
...
preset_validation_params.min_reward_threshold = hyperp.min_reward_threshold
preset_validation_params.max_episodes_to_achieve_reward = hyperp.max_episodes_to_achieve_reward
