...
class MaskRCNNService:
    ...
    def get_predictor(cls):
        ...
        with cls.lock:
            ...
            faster_rcnn_model = ResNetFPNModel()
            ...
            try:
                rpn_anchor_sizes = eval(os.environ['RPN_ANCHOR_SIZES'])
            except:
                pass
            ...
            cfg.DATA.TRAIN='coco_trainKitti'
            cfg.DATA.VAL='coco_valKitti'
            register_coco(cfg.DATA.BASEDIR)
            finalize_configs(is_training=False)

            # Create an inference model
            # PredictConfig takes a model, input tensors and output tensors
            input_tensors = faster_rcnn_model.get_inference_tensor_names()[0]
            output_tensors = faster_rcnn_model.get_inference_tensor_names()[1]
