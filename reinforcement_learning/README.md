...
-  [Game Server Auto-pilot](rl_game_server_autopilot) Reduce player wait time by autoscale game-servers deployed in EKS cluster via RL approach by adding and removing EC2 instances in reaction to dynamically player usage.
