...
class TestCase(TestCase):
    ...
    def test_lambda_handler_happy_case(self,get_batch_metadata_mock, update_batch_status_mock, get_batch_metadata_by_labeling_job_name_mock, get_job_by_arn_mock):
        # Setup
        ...
        get_batch_metadata_by_labeling_job_name_mock.return_value = OutputTestData.get_batch_metadata_by_labeling_job_name_output
