...
class Benchmarker:
    ...
    def _run_benchmarking_tests(
        ...
        if hasattr(predictor, "predictor") and predictor.predictor is not None:
            ...
            #last_modified_time: datetime = date.today()
            metrics_time = {
            ...
            if hasattr(predictor, "instance_type") and predictor.instance_type is not None:
                ...
                logging.info(f"{logging_prefix(model_id)} No instance type provided. Using the default ml.g5.2xlarge for pricing calculations.")
            ...
            if hasattr(predictor, "instance_count") and predictor.instance_count is not None:
                ...
                logging.info(f"{logging_prefix(model_id)} No initial_instance_count provided. Using the default count 1.")
    ...
    def run_single_model(self, model_id: str, model_args: Dict[str, Any]) -> Tuple[List[Dict[str, Any]], CustomPredictor]:
