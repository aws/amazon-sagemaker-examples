...
def model_fn(model_dir):
    ...
    """
    sym, arg_params, aux_params = onnx_mxnet.import_model('%s/ResNet_DUC_HDC.onnx' % model_dir) 
    # create module
...
def transform_fn(mod, data, input_content_type, output_content_type):
    ...
    :param mod: The resnet-duc model.
    ...
    return json.dumps(labels.tolist()), output_content_type
