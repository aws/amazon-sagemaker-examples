...
class RewardParam(Enum):
    ...
    PROJECTION_DISTANCE = [
        "projection_distance",
        0.0,
    ]  # float: race car distance projected on the centerline
    ...
    CLS_WAYPNY = [
        "closest_waypoints",
        [0, 0],
    ]  # list of int: list of int with size 2 containing closest prev and next waypoint indexes
    ...
    CLOSEST_OBJECTS = [
        "closest_objects",
        [0, 0],
    ]  # list of int: list of int with size 2 containing closest prev and next object indexes
    OBJECT_LOCATIONS = [
        "objects_location",
        [],
    ]  # list of tuple: list of all object (x, y) locations
    OBJECTS_LEFT_OF_CENTER = [
        "objects_left_of_center",
        [],
    ]  # list of boolean: list of all object to the left of centerline or not
    ...
    OBJECT_CENTERLINE_PROJECTION_DISTANCES = [
        "objects_distance",
        [],
    ]  # list of float: list of object distance projected on the centerline
