...
def ppo_continuous_outputs(model):
    ...
    policy_head_mean_name = (
        "generalmodel0_singlemodel1_scaledgradhead0_continuousppohead0_dense0_fwd"
    )
    policy_head_mean = make_output(policy_head_mean_name, shape=(num_actions,))
    policy_head_std_name = (
        "generalmodel0_singlemodel1_scaledgradhead0_continuousppohead0_broadcast_mul0"
    )
