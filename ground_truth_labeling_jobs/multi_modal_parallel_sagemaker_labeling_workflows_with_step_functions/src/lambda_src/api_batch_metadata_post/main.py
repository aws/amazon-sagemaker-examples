...
def lambda_handler(event, context):
    ...
    if input_metadata_batch:
        return construct_validation_error('The system indicates the you have already input the down sampling rate ' +
    ...
    sfn_client.send_task_success(
        ...
        output = json.dumps({
            'batch_id'          : batch_metadata[BatchMetadataTableAttributes.FIRST_LEVEL_BATCH_METADATA_ID],
